...
public class weather_activity extends AppCompatActivity {
        ...
        private static final String TAG = www.wajit.krushisarthi.weather_activity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_weather);
            ...
            webView.setWebViewClient(new www.wajit.krushisarthi.weather_activity.HelpClient());
